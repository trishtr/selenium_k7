...
public class Component {
    ...
    public <T extends Component> List<T> findComponents(Class<T> componentClass, WebDriver driver) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The compnent must have a constructor with params: " +
        ...
        try {
            ...
            throw new IllegalArgumentException("The compnent must have a css selector");
        }
